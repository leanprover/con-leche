...
- **Lean4Lean** (Carneiro), https://arxiv.org/pdf/2403.14064 — the closest analogue to ConLeche's setting, and it goes the *other* way. §3.2.1:
...
The one option with no precedent I could find is (b): threading convergence as a premise on each transitivity/uniqueness lemma. McTT is the closest published analogue to ConLeche, and it explicitly does not do this.
