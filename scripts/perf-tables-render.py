...
if par:
    ...
    A("takes 718 s at one worker, 202 s at four and 120 s at eight, and the")
    A("instruction count moves 0.3 % across the three (8.10 T, 8.12 T,")
    A("8.12 T).  The wall times below are that phase plus the sequential")
