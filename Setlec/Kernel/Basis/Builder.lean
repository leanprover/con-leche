...
Written out with `Setlec.Expr`'s constructors and `Name.str` chains,
...
(`#annotate_basis`, `Setlec/Kernel/BasisGen.lean`).
-/

namespace Setlec

/-! The raw-pin builder: `Expr` constructors under the raw binder
annotations.  Opened by the pin modules (`Setlec/Kernel/Basis/*`,
`Setlec/Kernel/StdAxioms.lean`, `Setlec/Kernel/TrustAxioms.lean`). -/
