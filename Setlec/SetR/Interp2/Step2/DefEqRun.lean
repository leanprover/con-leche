...
def Denote2FuelDownM (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
...
continuation. -/
def DefEqCont2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
...
def DefEqStepAt2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
loop decrements. -/
theorem defeqLoop_cont2 {m : EnvS2UM V μ env} {fuel : Nat}
...
index. -/
theorem defeq_claims2 {m : EnvS2UM V μ env} {fuel : Nat}
...
quarter. -/
def Denote2Delta2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
def ProofIrrel2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
def ReduceNat2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
def DefEqSpine2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
...
def DefEqStuck2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
theorem whnfCore_package2 {m : EnvS2UM V μ env} {fuel d : Nat}
...
branches. -/
theorem delta_package2 {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defeqStep_claim2 {m : EnvS2UM V μ env} {fuel : Nat}
    (ihwc : WhnfCoreClaims2 μ m φ fuel)
    (hdel : Denote2Delta2 μ m φ fuel)
...
def StuckIrrel2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
...
def Denote2StrLit2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
`EnvS2` seal. -/
def AcvalParams2 {env : Env} (m : EnvS2UM V μ env) : Prop :=
...
losing the trail. -/
theorem acvalParams2 {env : Env} (m : EnvS2UM V μ env) :
    AcvalParams2 m :=
  m.acval_params
...
`denote2` at all. -/
def AppCongrStuck2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
...
reason. -/
def EtaCert2 (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
theorem acval_const_congr2 {m : EnvS2UM V μ env} (hap : AcvalParams2 m)
...
theorem whnfCoreClaims2B_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
def DefEqClaims2AP (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    isDefEqCore μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
theorem defEqClaims2AP_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
def DefEqCont2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (d : Nat)
    (k : Expr → Expr → CheckM Bool) : Prop :=
  ∀ {a b : Expr} {Δa : List AVExpr}, k a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStepAt2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {k : Expr → Expr → CheckM Bool},
...
theorem defeqLoop_cont2A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defeq_claims2A {m : EnvS2UM V μ env} {fuel : Nat}
    (hstep : DefEqStepAt2A μ m φ fuel) :
...
annotation. -/
def Denote2Delta2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) : Prop :=
...
def ProofIrrel2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.proofIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def ReduceNat2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
...
def DefEqSpine2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.defeqSpineP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStuck2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {Δa : List AVExpr} {k : Expr → Expr → CheckM Bool}
    {a b a' b' : Expr},
    defeqStep μ (pureFns μ env fuel) env d k a b = .ok true →
...
theorem whnfCore_package2A {m : EnvS2UM V μ env} {fuel F d : Nat}
    {Δa : List AVExpr} {a a' : Expr} {aa : AVExpr}
...
theorem delta_package2A {m : EnvS2UM V μ env}
...
theorem defeqStep_claim2A {m : EnvS2UM V μ env} {fuel : Nat}
    (ihwc : WhnfCoreClaims2B μ m φ fuel)
    (hdel : Denote2Delta2A μ m φ)
...
def StuckIrrel2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.stuckIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def Denote2StrLit2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) : Prop :=
...
def AppCongrStuck2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    isDefEqCore μ env fuel d a.getAppFn b.getAppFn = .ok true →
    Setlec.defEqListP μ env fuel d a.getAppArgs b.getAppArgs
...
def EtaCert2A (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {n : Name} {ty bd b : Expr} {mb : Setlec.BinderMeta}
    {Δa : List AVExpr},
    Setlec.etaCertP μ env fuel d n ty bd mb b = .ok true →
...
`defeqLoop` hands `defeqStep` a continuation already applied to the
ambient depth. -/
def DefEqCont2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (d : Nat)
    (k : Expr → Expr → CheckM Bool) : Prop :=
  ∀ {a b : Expr} {Δa : List AVExpr}, k a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStepAt2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {k : Expr → Expr → CheckM Bool},
...
theorem defeqLoop_cont2C {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defeq_claims2C {m : EnvS2UM V μ env} {fuel : Nat}
    (hstep : DefEqStepAt2C μ m φ fuel) :
...
def ProofIrrel2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.proofIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def ReduceNat2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {e e₂ : Expr} {Δa : List AVExpr} {F : Nat}
    {ea : AVExpr},
    Setlec.reduceNatP μ env fuel d e = .ok (some e₂) →
...
def DefEqSpine2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.defeqSpineP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStuck2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {Δa : List AVExpr} {k : Expr → Expr → CheckM Bool}
    {a b a' b' : Expr},
    defeqStep μ (pureFns μ env fuel) env d k a b = .ok true →
...
def StuckIrrel2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.stuckIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def AppCongrStuck2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    isDefEqCore μ env fuel d a.getAppFn b.getAppFn = .ok true →
    Setlec.defEqListP μ env fuel d a.getAppArgs b.getAppArgs
...
def EtaCert2C (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {n : Name} {ty bd b : Expr} {mb : Setlec.BinderMeta}
    {Δa : List AVExpr},
    Setlec.etaCertP μ env fuel d n ty bd mb b = .ok true →
...
theorem defeqStep_claim2C {m : EnvS2UM V μ env} {fuel : Nat}
...
`CtxOkR.openCong`. -/
theorem binder_ctxOk2_openCong {m : EnvS2UM V μ env} {fuel F d : Nat}
...
theorem binder_ctxOk2_openCong_sat (m : EnvS2UM V μ env) (fuel F : Nat)
...
theorem proofIrrel2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defEqSpine2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem stuckIrrel2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem appCongrStuck2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem etaCert2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defEqStuck2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
same application. -/
theorem reduceNat2C_of_A {m : EnvS2UM V μ env} {fuel : Nat}
...
every consumer. -/
def DefEqCont2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (d : Nat)
    (k : Expr → Expr → CheckM Bool) : Prop :=
  ∀ {a b : Expr} {Δa : List AVExpr}, k a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStepAt2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {k : Expr → Expr → CheckM Bool},
...
theorem defeqLoop_cont2D {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem defeq_claims2D {m : EnvS2UM V μ env} {fuel : Nat}
    (hstep : DefEqStepAt2D μ m φ fuel) :
...
def ProofIrrel2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.proofIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def ReduceNat2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {e e₂ : Expr} {Δa : List AVExpr} {F : Nat}
    {ea : AVExpr},
    Setlec.reduceNatP μ env fuel d e = .ok (some e₂) →
...
def DefEqSpine2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.defeqSpineP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def DefEqStuck2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {Δa : List AVExpr} {k : Expr → Expr → CheckM Bool}
    {a b a' b' : Expr},
    defeqStep μ (pureFns μ env fuel) env d k a b = .ok true →
...
def StuckIrrel2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    Setlec.stuckIrrelP μ env fuel d a b = .ok true →
    Expr.WScoped d a → a.looseBVarsBounded 0 = true →
...
def AppCongrStuck2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {a b : Expr} {Δa : List AVExpr},
    isDefEqCore μ env fuel d a.getAppFn b.getAppFn = .ok true →
    Setlec.defEqListP μ env fuel d a.getAppArgs b.getAppArgs
...
def EtaCert2D (μ : CheckMode) {env : Env} (m : EnvS2UM V μ env)
    (φ : Name → Nat) (fuel : Nat) : Prop :=
  ∀ {d : Nat} {n : Name} {ty bd b : Expr} {mb : Setlec.BinderMeta}
    {Δa : List AVExpr},
    Setlec.etaCertP μ env fuel d n ty bd mb b = .ok true →
...
theorem delta_package2D {m : EnvS2UM V μ env}
    (hdel : Denote2Delta2A μ m φ)
    {F d : Nat} {Δa : List AVExpr} {x y : Expr} {xa : AVExpr}
    (hu : Setlec.unfoldDefinition env x = some y)
    (hws : Expr.WScoped d x) (hb : x.looseBVarsBounded 0 = true)
...
with it. -/
theorem defeqStep_claim2D {m : EnvS2UM V μ env} {fuel : Nat}
...
theorem frame_appArg2D {m : EnvS2UM V μ env} {F d : Nat}
...
and could not take. -/
theorem binder_congr2D {m : EnvS2UM V μ env} {fuel F : Nat}
...
theorem defeqStuck_claim2D {m : EnvS2UM V μ env} {fuel F : Nat}
