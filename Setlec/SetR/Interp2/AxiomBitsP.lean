...
theorem whnf_sort_eq {fuel d : Nat} {u : Level} {e' : Expr}
  ...
  have h1 := Setlec.whnf_mono (Nat.le_add_right fuel 2) h
  rw [Setlec.whnf_sort env fuel d u] at h1
...
theorem inferTypeCore_eqSpineS {fuel d : Nat} {X Y Z bt : Expr}
  ...
  injection Setlec.whnf_forallE_eq hw3 with e1 e2 e3 e4
  subst e3
  subst hb2
  ...
  injection Setlec.whnf_forallE_eq hw2 with f1 f2 f3 f4
  subst f3
  subst hb1
  ...
  injection Setlec.whnf_forallE_eq hw1 with g1 g2 g3 g4
  subst g3
  rfl
