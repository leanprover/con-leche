...
/-! `erase_eq_const` moved to `Setlec/SetBase/Syntax.lean` at THE
SEPARATION's S2, beside `AVExpr.erase` itself: it is pure syntax, and
the graded lane's `Step2/IrrelP` was importing this 2U module for it.
Name and statement unchanged. -/
