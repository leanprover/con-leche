...
/-! `checkDeclSPStep_run` moved to
`Setlec/Verify/BridgePDecl.lean` (task #148 T6): both soundness routes
need the parsed-index step's bridge, and it mentions no set theory. -/
