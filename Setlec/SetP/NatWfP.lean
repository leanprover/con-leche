...
theorem natLitP_one (m : EnvS2Core V env) (ρ : Nat → V) :
    interp2 V ρ (natLitP m φ 1)
      = SetTheory.app (interp2 V ρ (m.acval Setlec.natSuccName φ))
          (interp2 V ρ (m.acval Setlec.natZeroName φ)) := rfl
...
theorem divModClausesP_gcd {x y : V}
    ...
    (SetTheory.app (SetTheory.app
      ...
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natGcdName φ)) x) y
        = SetTheory.app (SetTheory.app
            (interp2 V ρ (m.acval Setlec.natGcdName φ))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natModName φ)) y) x)) x) ∧
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) x
      = interp2 V ρ (m.acval Setlec.boolFalseName φ) →
      SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natGcdName φ)) x) y = y) := by
  rw [natLitP_one]
...
theorem divModClausesP_shiftLeft {x y : V}
    (h : DivModClausesV V (fun n => interp2 V ρ (m.acval n φ))
      Setlec.natShiftLeftName x y) :
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) y
      = interp2 V ρ (m.acval Setlec.boolTrueName φ) →
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natShiftLeftName φ)) x) y
        = SetTheory.app (SetTheory.app
            (interp2 V ρ (m.acval Setlec.natShiftLeftName φ))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natMulName φ))
              (interp2 V ρ (natLitP m φ 2))) x))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natSubName φ)) y)
              (interp2 V ρ (natLitP m φ 1)))) ∧
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) y
      = interp2 V ρ (m.acval Setlec.boolFalseName φ) →
      SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natShiftLeftName φ)) x) y = x) := by
...
theorem divModClausesP_shiftRight {x y : V}
    (h : DivModClausesV V (fun n => interp2 V ρ (m.acval n φ))
      Setlec.natShiftRightName x y) :
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) y
      = interp2 V ρ (m.acval Setlec.boolTrueName φ) →
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natShiftRightName φ)) x) y
        = SetTheory.app (SetTheory.app
            (interp2 V ρ (m.acval Setlec.natDivName φ))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natShiftRightName φ)) x)
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natSubName φ)) y)
                (interp2 V ρ (natLitP m φ 1)))))
            (interp2 V ρ (natLitP m φ 2))) ∧
...
theorem divModClausesP_land {x y : V}
    (h : DivModClausesV V (fun n => interp2 V ρ (m.acval n φ))
      Setlec.natLandName x y) :
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) x
      = interp2 V ρ (m.acval Setlec.boolTrueName φ) →
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natLandName φ)) x) y
        = SetTheory.app (SetTheory.app
            ...
            (SetTheory.app (SetTheory.app
              ...
              (interp2 V ρ (natLitP m φ 2)))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natLandName φ))
                (SetTheory.app (SetTheory.app
                  (interp2 V ρ (m.acval Setlec.natDivName φ)) x)
                  (interp2 V ρ (natLitP m φ 2))))
                (SetTheory.app (SetTheory.app
                  (interp2 V ρ (m.acval Setlec.natDivName φ)) y)
                  (interp2 V ρ (natLitP m φ 2))))))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natMulName φ))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natModName φ)) x)
                (interp2 V ρ (natLitP m φ 2))))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natModName φ)) y)
                (interp2 V ρ (natLitP m φ 2))))) ∧
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) x
...
theorem divModClausesP_lor {x y : V}
    (h : DivModClausesV V (fun n => interp2 V ρ (m.acval n φ))
      Setlec.natLorName x y) :
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) x
      = interp2 V ρ (m.acval Setlec.boolTrueName φ) →
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natLorName φ)) x) y
        = SetTheory.app (SetTheory.app
            (interp2 V ρ (m.acval Setlec.natAddName φ))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natMulName φ))
              (interp2 V ρ (natLitP m φ 2)))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natLorName φ))
                (SetTheory.app (SetTheory.app
                  (interp2 V ρ (m.acval Setlec.natDivName φ)) x)
                  (interp2 V ρ (natLitP m φ 2))))
                (SetTheory.app (SetTheory.app
    ...
    (SetTheory.app (SetTheory.app
      ...
      = interp2 V ρ (m.acval Setlec.boolFalseName φ) →
      SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natLorName φ)) x) y = y) := by
  rw [natLitP_one, natLitP_two]
  simpa +decide only [DivModClausesV, if_false, if_true] using h
...
theorem divModClausesP_xor {x y : V}
    (h : DivModClausesV V (fun n => interp2 V ρ (m.acval n φ))
      Setlec.natXorName x y) :
    (SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natBleName φ))
        (interp2 V ρ (natLitP m φ 1))) x
      = interp2 V ρ (m.acval Setlec.boolTrueName φ) →
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natXorName φ)) x) y
        = SetTheory.app (SetTheory.app
            (interp2 V ρ (m.acval Setlec.natAddName φ))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natMulName φ))
              (interp2 V ρ (natLitP m φ 2)))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natXorName φ))
                (SetTheory.app (SetTheory.app
                  (interp2 V ρ (m.acval Setlec.natDivName φ)) x)
                  (interp2 V ρ (natLitP m φ 2))))
                (SetTheory.app (SetTheory.app
                  ...
                  (interp2 V ρ (natLitP m φ 2))))))
            (SetTheory.app (SetTheory.app
              (interp2 V ρ (m.acval Setlec.natModName φ))
              (SetTheory.app (SetTheory.app
                (interp2 V ρ (m.acval Setlec.natAddName φ))
                (SetTheory.app (SetTheory.app
                  (interp2 V ρ (m.acval Setlec.natModName φ)) x)
    ...
    (SetTheory.app (SetTheory.app
      ...
      = interp2 V ρ (m.acval Setlec.boolFalseName φ) →
      SetTheory.app (SetTheory.app
        (interp2 V ρ (m.acval Setlec.natXorName φ)) x) y = y) := by
  rw [natLitP_one, natLitP_two]
  simpa +decide only [DivModClausesV, if_false, if_true] using h
...
theorem natOpV2_divmod (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    ...
    (hc : c = Setlec.natDivName ∨ c = Setlec.natModName)
    ...
    ∀ a b : Nat,
      ...
      = interp2 V ρ (natLitP m φ
          (if c = Setlec.natDivName then a / b else a % b)) := by
  have hcmem : c ∈ Setlec.natDivModNames := by
    rcases hc with rfl | rfl <;> decide
  obtain ⟨hg, hclauses⟩ := hdm c hcmem cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  have hdepmem : Setlec.natSubName ∈ Setlec.natOpDeps c ∧
      Setlec.natBleName ∈ Setlec.natOpDeps c := by
    rcases hc with rfl | rfl <;> exact ⟨by decide, by decide⟩
  obtain ⟨cvsu, vsu, hsu, hfsu, -⟩ := hdeps Setlec.natSubName hdepmem.1
  obtain ⟨cvbl, vbl, hbl, hfbl, -⟩ := hdeps Setlec.natBleName hdepmem.2
  intro a b
  ...
  | ind a ih =>
    ...
    · by_cases hba : b ≤ a
      · have h1 : SetTheory.app (SetTheory.app
        ...
        by_cases hcd : c = Setlec.natDivName
        · subst hcd
...
theorem natOpV2_div (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    ...
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natDivName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natDivName φ))
...
theorem natOpV2_mod (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natModName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natModName φ))
...
theorem natOpV2_gcd (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natGcdName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natGcdName φ))
  ...
  obtain ⟨hg, hclauses⟩ := hdm Setlec.natGcdName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvmo, vmo, himo, hfmo, -⟩ := hdeps Setlec.natModName (by decide)
  intro a b
...
theorem natOpV2_shiftLeft (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natShiftLeftName
  ...
  obtain ⟨hg, hclauses⟩ :=
    hdm Setlec.natShiftLeftName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvsu, vsu, hisu, hfsu, -⟩ := hdeps Setlec.natSubName (by decide)
  obtain ⟨cvmu, vmu, himu, hfmu, -⟩ := hdeps Setlec.natMulName (by decide)
  intro a b
...
theorem natOpV2_shiftRight (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natShiftRightName
      = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natShiftRightName φ))
          (interp2 V ρ (natLitP m φ a)))
        (interp2 V ρ (natLitP m φ b))
      = interp2 V ρ (natLitP m φ (Nat.shiftRight a b)) := by
  obtain ⟨hg, hclauses⟩ :=
    hdm Setlec.natShiftRightName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvsu, vsu, hisu, hfsu, -⟩ := hdeps Setlec.natSubName (by decide)
...
theorem natOpV2_land (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natLandName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natLandName φ))
  ...
  obtain ⟨hg, hclauses⟩ :=
    hdm Setlec.natLandName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvad, vad, hiad, hfad, -⟩ := hdeps Setlec.natAddName (by decide)
  obtain ⟨cvmu, vmu, himu, hfmu, -⟩ := hdeps Setlec.natMulName (by decide)
  obtain ⟨cvdi, vdi, hidi, hfdi, -⟩ := hdeps Setlec.natDivName (by decide)
  obtain ⟨cvmo, vmo, himo, hfmo, -⟩ := hdeps Setlec.natModName (by decide)
  intro a b
...
theorem natOpV2_lor (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natLorName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natLorName φ))
  ...
  obtain ⟨hg, hclauses⟩ :=
    hdm Setlec.natLorName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvad, vad, hiad, hfad, -⟩ := hdeps Setlec.natAddName (by decide)
  obtain ⟨cvmu, vmu, himu, hfmu, -⟩ := hdeps Setlec.natMulName (by decide)
...
theorem natOpV2_xor (hops : NatOpsP m φ) (hnh : NatHeadsP m φ)
    (hval : AcvalValidP m) (hdm : DivModP m φ)
    {cv : ConstantVal} {v : Expr} {hint : ReducibilityHint}
    (hf : env.find? Setlec.natXorName = some (.defnInfo cv v hint))
    (ρ : Nat → V) :
    ∀ a b : Nat,
      SetTheory.app (SetTheory.app
          (interp2 V ρ (m.acval Setlec.natXorName φ))
  ...
  obtain ⟨hg, hclauses⟩ :=
    hdm Setlec.natXorName (by decide) cv v hint hf
  obtain ⟨hs, hdeps, -⟩ := Setlec.natOpGuard_inv hg
  obtain ⟨cvbl, vbl, hibl, hfbl, -⟩ := hdeps Setlec.natBleName (by decide)
  obtain ⟨cvad, vad, hiad, hfad, -⟩ := hdeps Setlec.natAddName (by decide)
  obtain ⟨cvmu, vmu, himu, hfmu, -⟩ := hdeps Setlec.natMulName (by decide)
