import Setlec.SetP.Direct.TowerConsP
...
the recursor — are exactly the head kinds `capsOkP_cons_fresh`
...
theorem capsOkP_cons_direct (mp : EnvS2PM V μ env)
    {c₀ : ConstantInfo} {A : (Name → Nat) → AVExpr} {T : Name}
