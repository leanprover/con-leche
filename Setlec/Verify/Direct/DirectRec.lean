...
`directRecRhs`, `Setlec/Kernel/Direct/Parts.lean`): the type former's
...
theorem NoProjAt.directCtorSpineAt (C : Name) (lps : List Name) (o nP nF : Nat) :
  ...
  unfold Setlec.directCtorSpineAt
...
theorem NoProjAt.directRecTy {T' C : Name} {lps : List Name} {elim : Name}
    ...
    (h : Setlec.directRecTy T' lps elim large nP tty [(C, nF, cty)] = some recTy)
...
theorem NoProjAt.directRecRhs {T' C : Name} {lps : List Name} {elim : Name}
    ...
    (h : Setlec.directRecRhs T' lps elim large nP tty [(C, nF, cty)] 0 = some rhs)
