              ...
              | indInfo cvT caps =>
                ...
                · rw [if_pos hK, if_pos hK]
                  ...
                  | const T' ust =>
                    ...
                    subst bq
                    replace htmajd := denote_mono hextb htmajd
  ...
  | const cᵢ us =>
    ...
    | some ci =>
      ...
      | recInfo cv mI rP rules =>
        ...
        · have hbv : denoteNode s₀.store.denote s₀.store.denoteL s₀.store.denoteN (.bvar 0)
              = some (.bvar 0) := rfl
