...
Port of `Setlec/Verify/BridgeS4.lean` for the cached tier.  Composes
the single-environment walks (`Setlec/Verify/Cached/BridgeCS*.lean`)
along the thin phase drivers of `Setlec/Cached/CheckerC.lean` into the
