...
Relocated out of `Setlec/TTVerify/{NatOpsStep,StrLitStep}.lean`
...
`Setlec/SetR/*` bridge at R7/R16 (`Red.strLitCtor`'s `denoteClosed` side
...
The namespace is `Setlec.TTVerify` because that is where `denote` and
